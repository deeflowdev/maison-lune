  ...
  return (
    <section className="border-t border-[#d6ccc2] pt-10 mt-10">
      <div className="max-w-xl mx-auto text-center">
        <h2 className="text-4xl font-medium heading-font text-[#1f1d1b] tracking-tight">
        ...
        <div className="mt-8 flex flex-col sm:flex-row gap-3 justify-center">
          ...
          <button className="px-6 py-3 bg-[#1f1d1b] text-white text-sm hover:bg-[#2a2623] transition-colors duration-300 uppercase">
            subscribe
          </button>
        </div>
