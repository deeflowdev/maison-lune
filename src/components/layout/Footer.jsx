  ...
  return (
    <footer className="bg-[#EDE0D4] px-10 py-12 text-[#5e503f] border-t border-[#d6ccc2]">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 lg:gap-16">
        ...
        <div>
          <h2 className="heading-font text-2xl lg:text-3xl mb-4 whitespace-nowrap">
            Maison Lune
          </h2>

          <p className="text-sm leading-6 max-w-xs text-[#1f1d1b]/80">
      ...
      {/* bottom section */}
      <div className="border-t border-[#d6ccc2] mt-12 pt-6 flex justify-between text-[10px] md:text-xs uppercase tracking-[0.15em]">
